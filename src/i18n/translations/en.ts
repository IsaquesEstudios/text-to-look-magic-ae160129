export const en = {
  ...
  auth: {
    ...
    nameTaken: "This name is already taken.",
     ...
     captchaRequired: "Please solve the equation correctly to continue.",
     solveEquation: "Solve:",
     ...
     pendingDescription: "Thank you for signing up! Discovery Investimentos is an exclusive platform for qualified investors. Our team is reviewing your information and you will receive a confirmation within 24 hours. We appreciate your patience.",
      ...
      rejectedTitle: "Registration Not Approved",
       ...
       personTypeTitle: "Person Type",
       personTypeDescription: "Select your person type and fill in the details",
       individual: "Individual",
       business: "Business Entity",
       itinSsn: "ITIN / SSN",
       itinSsnPlaceholder: "000-00-0000",
       itinSsnInvalid: "Invalid format. Use XXX-XX-XXXX (9 digits).",
       passport: "Passport",
       passportPlaceholder: "Passport number",
       passportInvalid: "Passport must be 5-20 alphanumeric characters.",
       ein: "EIN",
       einPlaceholder: "00-0000000",
       einInvalid: "Invalid format. Use XX-XXXXXXX (9 digits).",
       selectPersonType: "Select person type",
       forgotPassword: "Forgot your password?",
       forgotPasswordTitle: "Recover Password",
       forgotPasswordDescription: "Enter your email to receive a recovery link.",
       ...
       passwordResetSuccessDescription: "Your password has been changed. Please sign in.",
  ...
  panel: {
    ...
    receiptsDesc: "Send and track your payment receipts",
    received: "Received",
    sent: "Sent",
    recharges: "Deposits",
    noReceivedReceipts: "No receipts from admin yet",
    noSentReceipts: "No receipts sent yet",
    noRecharges: "No deposits yet",
    uploadReceipt: "Upload receipt",
    uploadReceiptDesc: "Click or drag to upload a receipt (image or PDF)",
    uploading: "Uploading...",
    ...
    deleteUserConfirm: "Are you sure you want to delete the account of",
    deleteUserIrreversible: "This action is irreversible.",
    balanceWarningTitle: "Account balance",
    balanceWarning: "This user has {amount} in credits. The balance will be permanently lost.",
    linkedPropertiesTitle: "Property links",
    linkedPropertiesWarning: "This user is linked to {count} property(ies):",
    linkedPropertiesRemoved: "All links will be permanently removed.",
    ...
    maxValueExceeded: "Maximum allowed value: $99,999,999.99",
    creditsAdded: "added successfully!",
    error: "Error",
    unexpectedError: "An unexpected error occurred. Please try again.",
    auctionsInvested: "Auctions Invested",
    noAuctionInvestments: "No auction investments",
    depositsCount: "deposit(s)",
    paymentsReceived: "Payments Received from Client",
    paymentsSent: "Payments Sent to Client",
    send: "Send",
    noReceipts: "No receipts uploaded",
    imagesSent: "Images uploaded!",
    sendError: "Error uploading",
    removeError: "Error removing",
    uploadingImages: "Uploading images...",
    userNotFound: "User not found.",
    userDeleted: "User deleted successfully",
    creditAddedByAdmin: "Credit added by admin",
