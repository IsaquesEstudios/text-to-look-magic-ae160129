export const pt = {
  ...
  auth: {
    ...
    nameTaken: "Este nome já está em uso.",
     ...
     captchaRequired: "Resolva a equação corretamente para continuar.",
     ...
     pendingDescription: "Obrigado por se cadastrar! A Discovery Investimentos é uma plataforma exclusiva para investidores qualificados. Nossa equipe está analisando suas informações e você receberá uma confirmação em até 24 horas. Agradecemos sua paciência.",
      ...
      rejectedTitle: "Cadastro Não Aprovado",
       ...
       personTypeTitle: "Tipo de Pessoa",
       personTypeDescription: "Selecione o tipo de pessoa e preencha os dados",
       ...
       passport: "Passaporte",
       passportPlaceholder: "Número do passaporte",
       passportInvalid: "O passaporte deve ter entre 5 e 20 caracteres alfanuméricos.",
       ein: "EIN",
       einPlaceholder: "00-0000000",
       einInvalid: "Formato inválido. Use XX-XXXXXXX (9 dígitos).",
       selectPersonType: "Selecione o tipo de pessoa",
       forgotPassword: "Esqueceu sua senha?",
       forgotPasswordTitle: "Recuperar Senha",
       forgotPasswordDescription: "Informe seu email para receber o link de recuperação.",
       sendResetLink: "Enviar Link",
       resetLinkSent: "Link enviado!",
       resetLinkSentDescription: "Verifique seu email para redefinir sua senha.",
       ...
       passwordResetSuccessDescription: "Sua senha foi alterada com sucesso. Faça login.",
  ...
  panel: {
    ...
    rechargeAmount: "Valor do aporte (USD)",
    ...
    deleteUserConfirm: "Tem certeza que deseja excluir a conta de",
    deleteUserIrreversible: "Esta ação é irreversível.",
    balanceWarningTitle: "Saldo em conta",
    balanceWarning: "Este usuário possui {amount} em créditos. O saldo será perdido permanentemente.",
    linkedPropertiesTitle: "Vínculos a propriedades",
    linkedPropertiesWarning: "Este usuário está vinculado a {count} propriedade(s):",
    linkedPropertiesRemoved: "Todos os vínculos serão removidos permanentemente.",
    ...
    paymentsReceived: "Pagamentos Recebidos do Cliente",
    paymentsSent: "Pagamentos Feitos para o Cliente",
    send: "Enviar",
    noReceipts: "Nenhum comprovante enviado",
    imagesSent: "Imagens enviadas!",
    ...
    creditAddedByAdmin: "Crédito adicionado pelo admin",
