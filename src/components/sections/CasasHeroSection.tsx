...
interface CasasHeroSectionProps {
  title: string;
  description: string;
  ctaText: string;
...
export function CasasHeroSection({
  title,
  description,
  ctaText,
  backgroundImage,
}: CasasHeroSectionProps) {
  return (
      ...
      <div className="relative z-10 container mx-auto px-6 h-full flex items-center py-20 lg:py-32">
        ...
        >
          ...
          >
            ...
            <span className="text-sm text-discovery-green font-medium">House Flipping nos EUA</span>
          </motion.div>
