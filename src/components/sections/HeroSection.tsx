...
export function HeroSection({
  ...
  return (
    <section className="min-h-[75vh] sm:min-h-screen flex flex-col relative overflow-hidden pt-20">
      ...
      {/* Content */}
      <div className="relative z-10 flex-1 flex flex-col items-center justify-end px-6 pt-8 sm:pt-12 lg:pt-40 pb-0 mb-[-40px]">
        <motion.div
      ...
      <motion.div
        ...
        className="relative z-0 w-full px-4 sm:px-6 md:px-12 lg:px-20 pb-6 md:pb-12 -mt-20 lg:-mt-48 overflow-hidden"
      >
