...
export const RecoveryEmail = ({
  ...
  <Html lang="pt" dir="ltr">
    <Head />
    <Preview>Redefinição de senha — Discovery Investimentos</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={text}>
          Recebemos uma solicitação para redefinir sua senha na Discovery Investimentos. Clique no botão abaixo para escolher uma nova senha.
        </Text>
